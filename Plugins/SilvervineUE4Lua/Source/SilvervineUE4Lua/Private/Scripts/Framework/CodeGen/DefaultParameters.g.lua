...
do
    DefaultParameters.staticmeshdescription = DefaultParameters.staticmeshdescription or {}
    
    --SetVertexInstanceUV
    DefaultParameters.staticmeshdescription.setvertexinstanceuv = Class(DefaultParameterClass)
    DefaultParameters.staticmeshdescription.setvertexinstanceuv.uvindex = 0
    --GetVertexInstanceUV
    DefaultParameters.staticmeshdescription.getvertexinstanceuv = Class(DefaultParameterClass)
    DefaultParameters.staticmeshdescription.getvertexinstanceuv.uvindex = 0
end
...
--GameMapsSettings
do
    DefaultParameters.gamemapssettings = DefaultParameters.gamemapssettings or {}
    
    --SetSkipAssigningGamepadToPlayer1
    DefaultParameters.gamemapssettings.setskipassigninggamepadtoplayer1 = Class(DefaultParameterClass)
    DefaultParameters.gamemapssettings.setskipassigninggamepadtoplayer1.bskipfirstplayer = true
end
...
do
    ...
    --GetAttachedActors
    DefaultParameters.actor.getattachedactors = Class(DefaultParameterClass)
    DefaultParameters.actor.getattachedactors.bresetarray = true
    --GetAllChildActors
...
do
    ...
    DefaultParameters.materialinterface.setforcemiplevelstoberesident.bfastresponse = false
end
...
do
    ...
    --AdjustVolume
    DefaultParameters.audiocomponent.adjustvolume = Class(DefaultParameterClass)
    DefaultParameters.audiocomponent.adjustvolume.fadecurve = 0 --EAudioFaderCurve::Linear
    --Play
    ...
    --FadeOut
    DefaultParameters.audiocomponent.fadeout = Class(DefaultParameterClass)
    DefaultParameters.audiocomponent.fadeout.fadecurve = 0 --EAudioFaderCurve::Linear
    --FadeIn
    ...
    DefaultParameters.audiocomponent.fadein.fadecurve = 0 --EAudioFaderCurve::Linear
end
...
do
    ...
    DefaultParameters.splinecomponent.gettransformatsplineinputkey = Class(DefaultParameterClass)
    DefaultParameters.splinecomponent.gettransformatsplineinputkey.busescale = false
end
...
do
    ...
    DefaultParameters.gameplaystatics.spawnemitterattached.bautoactivate = true
    ...
    DefaultParameters.gameplaystatics.spawnemitteratlocation.bautoactivatesystem = true
...
do
    ...
    DefaultParameters.kismetmathlibrary.matrix_getscalevector = Class(DefaultParameterClass)
    DefaultParameters.kismetmathlibrary.matrix_getscalevector.tolerance = 0.000000
    --Matrix_GetMatrixWithoutScale
    DefaultParameters.kismetmathlibrary.matrix_getmatrixwithoutscale = Class(DefaultParameterClass)
    DefaultParameters.kismetmathlibrary.matrix_getmatrixwithoutscale.tolerance = 0.000000
    --Matrix_RemoveScaling
    DefaultParameters.kismetmathlibrary.matrix_removescaling = Class(DefaultParameterClass)
    DefaultParameters.kismetmathlibrary.matrix_removescaling.tolerance = 0.000000
    --NotEqual_MatrixMatrix
    DefaultParameters.kismetmathlibrary.notequal_matrixmatrix = Class(DefaultParameterClass)
    DefaultParameters.kismetmathlibrary.notequal_matrixmatrix.tolerance = 0.000100
    --EqualEqual_MatrixMatrix
    DefaultParameters.kismetmathlibrary.equalequal_matrixmatrix = Class(DefaultParameterClass)
    DefaultParameters.kismetmathlibrary.equalequal_matrixmatrix.tolerance = 0.000100
    --REase
...
do
    ...
    DefaultParameters.kismetrenderinglibrary.createrendertarget2d.format = 6 --ETextureRenderTargetFormat::RTF_RGBA16f
    ...
    DefaultParameters.kismetrenderinglibrary.createrendertarget2d.bautogeneratemipmaps = false
    --ClearRenderTarget2D
...
do
    ...
    DefaultParameters.userwidget.playanimationreverse.brestorestate = false
    ...
    DefaultParameters.userwidget.playanimationforward.brestorestate = false
    ...
    DefaultParameters.userwidget.playanimationtimerange.brestorestate = false
    --PlayAnimation
    ...
    DefaultParameters.userwidget.playanimation.brestorestate = false
...
do
    ...
    --AddBindingByTag
    DefaultParameters.levelsequenceactor.addbindingbytag = Class(DefaultParameterClass)
    DefaultParameters.levelsequenceactor.addbindingbytag.ballowbindingsfromasset = false
    --AddBinding
    ...
    --SetBindingByTag
    DefaultParameters.levelsequenceactor.setbindingbytag = Class(DefaultParameterClass)
    DefaultParameters.levelsequenceactor.setbindingbytag.ballowbindingsfromasset = false
    --SetBinding
...
do
    DefaultParameters.xrloadingscreenfunctionlibrary = DefaultParameters.xrloadingscreenfunctionlibrary or {}
    
    --AddLoadingScreenSplash
    DefaultParameters.xrloadingscreenfunctionlibrary.addloadingscreensplash = Class(DefaultParameterClass)
    DefaultParameters.xrloadingscreenfunctionlibrary.addloadingscreensplash.size = UE4.Vector2D.new(1.000000, 1.000000)
    DefaultParameters.xrloadingscreenfunctionlibrary.addloadingscreensplash.bclearbeforeadd = false
end
...
do
    DefaultParameters.magicleaphmdfunctionlibrary = DefaultParameters.magicleaphmdfunctionlibrary or {}
    
    --SetStabilizationDepthActor
    DefaultParameters.magicleaphmdfunctionlibrary.setstabilizationdepthactor = Class(DefaultParameterClass)
    DefaultParameters.magicleaphmdfunctionlibrary.setstabilizationdepthactor.bsetfocusactor = true
    --SetFocusActor
    DefaultParameters.magicleaphmdfunctionlibrary.setfocusactor = Class(DefaultParameterClass)
    DefaultParameters.magicleaphmdfunctionlibrary.setfocusactor.bsetstabilizationactor = true
end
...
do
    ...
    DefaultParameters.magicleaphandtrackingfunctionlibrary.setconfiguration.keypointsfilterlevel = 0 --EMagicLeapHandTrackingKeypointFilterLevel::NoFilter
    DefaultParameters.magicleaphandtrackingfunctionlibrary.setconfiguration.gesturefilterlevel = 0 --EMagicLeapHandTrackingGestureFilterLevel::NoFilter
    DefaultParameters.magicleaphandtrackingfunctionlibrary.setconfiguration.btrackingenabled = true
end

--NUTActor
do
    DefaultParameters.nutactor = DefaultParameters.nutactor or {}
    
    --UnitTravel
    DefaultParameters.nutactor.unittravel = Class(DefaultParameterClass)
    DefaultParameters.nutactor.unittravel.dest = " "
    --UnitSeamlessTravel
    DefaultParameters.nutactor.unitseamlesstravel = Class(DefaultParameterClass)
    DefaultParameters.nutactor.unitseamlesstravel.dest = " "
end
...
do
    DefaultParameters.steamvrinputdevicefunctionlibrary = DefaultParameters.steamvrinputdevicefunctionlibrary or {}
    
    --FindSteamVR_InputBindingInfo
    DefaultParameters.steamvrinputdevicefunctionlibrary.findsteamvr_inputbindinginfo = Class(DefaultParameterClass)
    DefaultParameters.steamvrinputdevicefunctionlibrary.findsteamvr_inputbindinginfo.actionset = "main"
    --GetSteamVR_HandPoseRelativeToNow
    DefaultParameters.steamvrinputdevicefunctionlibrary.getsteamvr_handposerelativetonow = Class(DefaultParameterClass)
    DefaultParameters.steamvrinputdevicefunctionlibrary.getsteamvr_handposerelativetonow.hand = 0 --ESteamVRHand::VR_Left
    DefaultParameters.steamvrinputdevicefunctionlibrary.getsteamvr_handposerelativetonow.predictedsecondsfromnow = 0.000000
    --FindSteamVR_ActionOrigin
    DefaultParameters.steamvrinputdevicefunctionlibrary.findsteamvr_actionorigin = Class(DefaultParameterClass)
    DefaultParameters.steamvrinputdevicefunctionlibrary.findsteamvr_actionorigin.actionset = "main"
    --FindSteamVR_OriginTrackedDeviceInfo
    DefaultParameters.steamvrinputdevicefunctionlibrary.findsteamvr_origintrackeddeviceinfo = Class(DefaultParameterClass)
    DefaultParameters.steamvrinputdevicefunctionlibrary.findsteamvr_origintrackeddeviceinfo.actionset = "main"
    --FindSteamVR_Action
    DefaultParameters.steamvrinputdevicefunctionlibrary.findsteamvr_action = Class(DefaultParameterClass)
    DefaultParameters.steamvrinputdevicefunctionlibrary.findsteamvr_action.actionset = "main"
    --GetSkeletalTransform
    DefaultParameters.steamvrinputdevicefunctionlibrary.getskeletaltransform = Class(DefaultParameterClass)
    DefaultParameters.steamvrinputdevicefunctionlibrary.getskeletaltransform.bwithcontroller = false
    --PlaySteamVR_HapticFeedback
    DefaultParameters.steamvrinputdevicefunctionlibrary.playsteamvr_hapticfeedback = Class(DefaultParameterClass)
    DefaultParameters.steamvrinputdevicefunctionlibrary.playsteamvr_hapticfeedback.durationseconds = 1.000000
    DefaultParameters.steamvrinputdevicefunctionlibrary.playsteamvr_hapticfeedback.frequency = 1.000000
    DefaultParameters.steamvrinputdevicefunctionlibrary.playsteamvr_hapticfeedback.amplitude = 0.500000
    --GetFingerCurlsAndSplays
    DefaultParameters.steamvrinputdevicefunctionlibrary.getfingercurlsandsplays = Class(DefaultParameterClass)
    DefaultParameters.steamvrinputdevicefunctionlibrary.getfingercurlsandsplays.summarydatatype = 0 --ESkeletalSummaryDataType::VR_SummaryType_FromAnimation
end
